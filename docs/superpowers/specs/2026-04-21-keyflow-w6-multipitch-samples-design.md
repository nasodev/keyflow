...
| MIDI | 대응 샘플 | pitch ratio | MIDI | 대응 샘플 | pitch ratio |
|------|-----------|-------------|------|-----------|-------------|
| 36 | C2v10 | 1.000 | 60 | C4v10 | 1.000 |
| 37 | C2v10 | 1.059 | 61 | C4v10 | 1.059 |
| 38 | Ds2v10 | 0.944 | 62 | Ds4v10 | 0.944 |
| 39 | Ds2v10 | 1.000 | 63 | Ds4v10 | 1.000 |
| 40 | Ds2v10 | 1.059 | 64 | Ds4v10 | 1.059 |
| 41 | Fs2v10 | 0.944 | 65 | Fs4v10 | 0.944 |
| 42 | Fs2v10 | 1.000 | 66 | Fs4v10 | 1.000 |
| ... (패턴 반복) ... | | | 81 | A5v10 | 1.000 |
| | | | 82 | C6v10 | 0.944 |
| | | | 83 | C6v10 | 1.000(??) |

정정: `ResolveSample` 알고리즘 검증

- midi 82: baseIdx = (82 − 36)/3 = 15(=A5 인덱스); sampleMidi = 81; offset = 1 → (A5v10, 1.059). ✅ (C6로 가지 않음)
- midi 83: baseIdx = (83 − 36)/3 = 15; sampleMidi = 81; offset = 2 → 분기 진입, baseIdx = 16; sampleMidi = 84; offset = -1 → (C6v10, 0.944). ✅
- midi 84: baseIdx = (84 − 36)/3 = 16; sampleMidi = 84; offset = 0 → (C6v10, 1.000). ✅ (실사용 없음, clamp 경계)

알고리즘 교차 검증 통과. 테스트(6.1) case #2, #3이 이를 증명하는 단위 테스트.
